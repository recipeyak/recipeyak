...
export const BITBUCKET_OAUTH_URL =
  "" + OAUTH_BITBUCKET_CLIENT_ID + OAUTH_BITBUCKET_REDIRECT_URI
export const FACEBOOK_OAUTH_URL =
  "" + OAUTH_FACEBOOK_CLIENT_ID + OAUTH_FACEBOOK_REDIRECT_URI
export const GOOGLE_OAUTH_URL =
  "" + OAUTH_GOOGLE_CLIENT_ID + OAUTH_GOOGLE_REDIRECT_URI
